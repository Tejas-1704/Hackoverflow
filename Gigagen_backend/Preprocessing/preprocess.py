...
def rmv_line_start_with(input_file, output_file, target_word):
    with open(input_file, 'r', encoding='utf-8') as file:
        lines = file.readlines()
...
remove_lines_with_sequence(r'C:\Users\Karthik Avinash\OneDrive\Desktop\HackOverflow\References\CharakaSamhita.txt', 'output_file.txt', 'Related:')

rmv_line_start_with('output_file.txt', 'output_file.txt', 'Save')
rmv_line_start_with('output_file.txt', 'output_file.txt', 'Related:')

combine_lines('output_file.txt', 'output_file.txt')
